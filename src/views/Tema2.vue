...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5
      ...
      .col-md-8.mb-5
        p Todo lo físico y tangible de un ordenador o sistema informático, se llama
          ...
          br
          | Hoy en día un televisor inteligente, una tableta, un teléfono celular, un reloj, puede ser un
          i hardware.
    ...
    .row.mb-5 
      p A continuación, se presenta un comparativo resumen del
    ...
    .row
      .col-lg-12
        .titulo-principal.color-acento-contenido
          .titulo-principal__numero
            span 
          h1 Manuales de usuarios tecnológicos
              ...
              .row.justify-content-center.mb-3
                ...
                .col-lg-12.tarjeta--green.t-2-nivel2-tarjeta
                  .row.justify-content-center.t-2-nivel3-tarjeta
                    ...
                    p.text-center Informar al usuario de la respuesta a cada mensaje de error.
    ...
    .row
      ...
      .col-lg-12
        ImagenInfograficaB.color-acento-botones.punto_caliente_acento_botones
          template(v-slot:imagen)
            figure
              img(src='@/assets/template/tema2/t2-i8.svg')

          div.p-5(x='28%', y='14%', tooltip='Portada, índice e introducción')
          ...
          div.p-5(x='36%', y='14%', tooltip='Instalación del software')
            h5 Instalación del 
             i software
          ...
          div.p-5(x='57%', y='15%', tooltip='Diagrama general del software')
          ...
          div.p-5(x='36%', y='81%', tooltip='Diagrama particular detallado')
          ...
          div.p-5(x='57%', y='81%', tooltip='Explicación genérica de las fases del software')
          ...
          div.p-5(x='73%', y='68%', tooltip='Iniciación al uso del software')
