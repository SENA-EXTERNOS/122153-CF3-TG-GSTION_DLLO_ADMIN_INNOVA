            ...
            .col-lg-12
              .cajon.color_cajon_tema_3_2.p-4
                p La
                  ...
                  i  extranet de una empresa no necesariamente el usuario ha de ser trabajador de la empresa, pero sí tener un vínculo con la entidad. Es por ello que una
                  i  extranet 
      ...
      .row
        ...
        .col-lg-8.order-2.order-lg-2
          TabsA.color-acento-contenido.mb-5 
            ...
            .tarjeta.clr-paleYellow.p-4.color--green(titulo='Envío de información a socios')
            ...
            .tarjeta.clr-paleYellow.p-4.color--green(titulo='Descarga de documentación')
            ...
            .tarjeta.clr-paleYellow.p-4.color--green(titulo='Preguntas frecuentes')
    ...
    .row.mb-5
      .col-lg-12
        .titulo-principal.color-acento-contenido
          .titulo-principal__numero
            span 
          h1 Tipos de conectividad

      .col-lg-12
        p Se distinguen básicamente dos tipos, cableadas e inalámbricas, pero entre ellas existen gran variedad de subtipos de conexión que también tienen una importancia relativa en el mercado, dado el nicho específico al que quiere llegar y necesidades de los clientes potenciales. Conozca los subtipos de los tipos de conectividad.
